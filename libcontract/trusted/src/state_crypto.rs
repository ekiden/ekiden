...
pub fn decrypt_state<S: protobuf::MessageStatic>(encrypted_state: &CryptoSecretbox) -> Result<S, protobuf::ProtobufError> {
...
pub fn encrypt_state<S: protobuf::Message>(state: &S) -> Result<CryptoSecretbox, protobuf::ProtobufError> {
